...
/*Note generate new command
after create rum_model.g.dart file ->
Run this command " flutter pub run build_runner build "
or use to always watch for changes
...
class RumModel {
  ...
  RumModel({this.drinks});

  //FromJson
  factory RumModel.fromJson(Map<String, dynamic> map) =>
      _$RumModelFromJson(map);
